...
export const createSalesmen = async (req, res) => {
    try {
...
export const getSalesmenById = async (req, res) => {
    try {
        ...
        const salesmen = await db
            ...
            .from(salesmenTable)
            .innerJoin(usersTable, eq(salesmenTable.userId, usersTable.id))
            .where(and(eq(salesmenTable.id, id), eq(salesmenTable.companyId, user.companyId)));
...
export const updateSalesmen = async (req, res) => {
    try {
        const id = req.params.id;
...
export const deleteSalesmen = async (req, res) => {
    try {
        const id = req.params.id;
        const user = req.user;
        const result = await db.transaction(async (tx) => {
